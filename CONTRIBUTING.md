...
Copyright and license information for all files is declared in `REUSE.toml`.
...
- If the file originates from another project or has a different copyright holder, add a corresponding entry in `REUSE.toml`.
