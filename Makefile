...
$(TLS_DYLIBNAME): $(TLS_OBJS)
	$(TLS_DYLIB_MAKE_CMD) -o $(TLS_DYLIBNAME) $(TLS_OBJS) $(REAL_LDFLAGS) $(LDFLAGS) $(DYLIBNAME) $(TLS_LDFLAGS)

$(TLS_STLIBNAME): $(TLS_OBJS)
	$(STLIB_MAKE_CMD) $(TLS_STLIBNAME) $(TLS_OBJS)

$(RDMA_DYLIBNAME): $(RDMA_OBJS)
	$(RDMA_DYLIB_MAKE_CMD) -o $(RDMA_DYLIBNAME) $(RDMA_OBJS) $(REAL_LDFLAGS) $(LDFLAGS) $(DYLIBNAME) $(RDMA_LDFLAGS)
