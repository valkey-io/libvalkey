...
TEST_SRCS = $(TEST_DIR)/client_test.c $(TEST_DIR)/ut_parse_cmd.c \
	    $(TEST_DIR)/ut_slotmap_update.c $(TEST_DIR)/ut_timer.c
...
LIBVALKEY_DISABLE_FFC_IMPL?=0
ifeq ($(LIBVALKEY_DISABLE_FFC_IMPL),1)
  REAL_CFLAGS+=-DDISABLE_FFC_IMPL
endif
